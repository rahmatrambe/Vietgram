        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="images/rahmat25.jpg" class="edit-profile__avatar" />
                </div>
            ...
            <form action="edit.php" method="post" class="edit-profile__form">
                <div class="form__row">
                    ...
                    <input id="full-name" name="full-name" type="text" class="form__input" />
                </div>
                <div class="form__row">
                    <label for="user-name" class="form__label">Username:</label>
                    <input id="user-name" name="user-name" type="text" class="form__input" />
                </div>
                <div class="form__row">
